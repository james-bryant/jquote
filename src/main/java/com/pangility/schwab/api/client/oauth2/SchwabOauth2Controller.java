...
public class SchwabOauth2Controller {
     ...
     */
    public void init(List<SchwabAccount> schwabAccounts, SchwabTokenHandler tokenHandler) {
     ...
     */
    public SchwabAccount getSchwabAccount(String schwabUserId) {
     ...
     * @return {@link Mono}{@literal <}{@link SchwabAccount}{@literal >}
     */
    public Mono<SchwabAccount> getAccessToken(String schwabUserId) {
     ...
     * @return {@link Mono}{@literal <}{@link SchwabAccount}{@literal >}
     */
    public Mono<SchwabAccount> refreshAccessToken(String schwabUserId) {
     ...
     * @return {@link Mono}{@literal <}{@link SchwabAccount}{@literal >}
     */
    public Mono<SchwabAccount> refreshAccessToken(SchwabAccount schwabAccount) {
        String tokenAuthorizationHeader = "Basic " + Base64.getEncoder()
                .encodeToString((schwabClientId + ":" + schwabClientSecret).getBytes(StandardCharsets.UTF_8));
